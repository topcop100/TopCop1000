...
public class MainActivity extends Activity {
    ...
    final class GraveyardView extends View {
        ...
        void refreshPrefs(){loadOrder();loadVisibility();zombies=prefs.getBoolean("zombies",true);if(focus<10&&!visible[tileAt(focus)]){for(int i=0;i<10;i++){if(visible[tileAt(i)]){focus=i;break;}}}invalidate();}
